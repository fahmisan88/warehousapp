class Parcel < ApplicationRecord
  ...
  enum status: [:Waiting, :Arrived, :"Ready To Ship", :Shipped, :"Request Refund", :Refunding, :Refunded, :"need user action"]
  ...
  def self.search(search)
      where('awb ILIKE :search OR new_awb ILIKE :search OR ezi_id ILIKE :search', search: "%#{search}%")
  end
